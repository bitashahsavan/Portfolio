...
export const serviceData = [
    { icon: assets.web_icon, title: 'Web Development', description: '“Building fast, responsive, and modern websites using Next.js and React, with clean and maintainable code that ensures smooth user experiences.”', link: '' },
    { icon: assets.ui_icon, title: 'UI/UX Design Integration ', description: '“Transforming designs into interactive interfaces with attention to user experience, ensuring websites are intuitive, visually appealing, and easy to navigate.”', link: '' },
    { icon: assets.mobile_icon, title: 'API & Backend Integration', description: '“Connecting websites with APIs and backend services, handling data efficiently, and making sure everything works seamlessly on the front end.”', link: '' },
    { icon: assets.graphics_icon, title: 'Performance Optimization', description: '“Improving website speed and performance, optimizing images, code, and loading times to provide a fast and reliable experience for users.”', link: '' },
]
